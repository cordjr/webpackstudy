...
export let NegociacaoController = (_dec = controller('#data', '#quantidade', '#valor'), _dec2 = bindEvent('submit', '.form'), _dec3 = debounce(), _dec4 = bindEvent('click', '#botao-importa'), _dec5 = debounce(), _dec6 = bindEvent('click', '#botao-apaga'), _dec(_class = (_class2 = class NegociacaoController {
    ...
    importaNegociacoes() {
        ...
        return _asyncToGenerator(function* () {
            ...
            try {
                const { NegociacaoService } = yield System.import('../domain/negociacao/NegociacaoService');
